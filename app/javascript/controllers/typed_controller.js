...
export default class extends Controller {
    connect() {
        const options = {
            strings: ["<br>Hello!", "Nice to meet you!<br>We are Kite in Moris!", "All you need about kitesurf in our paradise island.", "Find a school, the best spot, or your gear.", "Find your accommodation, or best restaurant.", "Find an event, and your friends.", "Join our community,", "with happiness, and passion.", "Live your dream, meet the paradise.", "Feel the sea, touch the sand.", "<br>We are Kite in Moris!"],
            typeSpeed: 37,
            backSpeed: 10,
            showCursor: false,
            loop: false,
